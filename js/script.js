(function () {
    ...
    tableImg.setAttribute('id', 'tableImg');
    ...
    email.setAttribute('class', 'inp');
    lastName.setAttribute('class', 'inp');
    firstName.setAttribute('class', 'inp');
    skills.setAttribute('class', 'inp');
    cancel.setAttribute('id', 'cancel');
    cancel.setAttribute('value', 'cancel');
    save.setAttribute('value', 'save');
    save.setAttribute('id', 'save');
    sort.setAttribute('value', 'sort');
    sort.setAttribute('id', 'sort');
    add.setAttribute('id', 'add');
    add.setAttribute('value', 'add');
    head.innerHTML = 'List of students';
    ...
    for (var i = 0; i < students.length; i++) {
        ...
        for (var j = 0; j <= 6; j++) {
            ...
            case 2:
                ...
                break;
            case 3:
                td.innerHTML = students[i].skills;
                break;
            case 4:
                edit = document.createElement('button');
                td.appendChild(edit);
                edit.innerHTML = 'edit';
                edit.setAttribute('id', 'button' + i);
            ...
            case 5:
                ...
                photo.setAttribute('src', students[i].img);
                if (photo.getAttribute('src') == 'undefined' || photo.getAttribute('src') == "" || photo.getAttribute('src') == null) {
                    photo.setAttribute('src', 'http://www.freeiconspng.com/uploads/x-png-18.png')
                }
                break;
            case 6:
    ...
    document.getElementById('add').onclick = function () {
        if (document.getElementById('firstName').value != null && document.getElementById('lastName').value != null && document.getElementById('email').value != null && document.getElementById('skills') != null) {
            students.push({
            ...
            for (var j = 0; j <= 6; j++) {
                ...
                switch (j) {
                case 0:
                    column.innerHTML = students[students.length - 1].name;
                    break;
                case 1:
                    column.innerHTML = students[students.length - 1].lastName;
                    break;
                case 2:
                    column.innerHTML = students[students.length - 1].email;
                    break;
                case 3:
                    column.innerHTML = students[students.length - 1].skills;
                    break;
                case 4:
                    edit = document.createElement('button');
                    column.appendChild(edit);
                    edit.innerHTML = 'edit';
                    edit.setAttribute('id', 'button' + (students.length - 1).toString());
                    edit.setAttribute('class', 'button')
                    break;
                case 5:
                    photo = document.createElement('img');
                    ...
                    photo.setAttribute('class', 'photo');
                    photo.setAttribute('src', students[students.length - 1].img);
                    if (photo.getAttribute('src') == 'undefined' || photo.getAttribute('src') == "") {
                        photo.setAttribute('src', 'http://www.freeiconspng.com/uploads/x-png-18.png')
                    }
                    break;
                case 6:
                    ...
                    del.innerHTML = 'delete';
                    del.setAttribute('id', 'del' + (students.length - 1).toString());
                    del.setAttribute('class', 'del');
                }
            }
        }
    ...
    for (var i = 0; i < but.length; i++) {
        but[i].onclick = function () {
            z = this.getAttribute('id').slice(6, this.getAttribute('id').length);
            document.getElementById('firstName').value = students[z].name;
            document.getElementById('lastName').value = students[z].lastName;
            document.getElementById('email').value = students[z].email;
            document.getElementById('skills').value = students[z].skills;
            document.getElementById('tableImg').setAttribute('src', students[z].img);
        }
    }
    var trArr = document.getElementsByTagName('tr');
    var delet = document.getElementsByClassName('del');
    for (var i = 0; i < delet.length; i++) {
        delet[i].onclick = function () {
            z = this.getAttribute('id').slice(3, this.getAttribute('id').length);
            console.log(z);
            console.log(students[z]);
            students.splice(z, 1);
            body.removeChild(trArr[z]);
        }
    }
    ...
    console.log('del' + (students.length - 1).toString());
})();